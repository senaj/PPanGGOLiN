...
def annotatePangenome(pangenome, fastaList, tmpdir, cpu, translation_table="11", kingdom = "bacteria", norna=False,  overlap=True, contig_filter=500):
...
def launch(args):
    ...
    if args.fasta is not None and args.anno is None:
        annotatePangenome(pangenome, args.fasta, args.tmpdir, args.cpu,  args.translation_table, args.kingdom, args.norna, args.overlap, contig_filter = args.contig_filter)
